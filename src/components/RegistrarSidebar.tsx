...
const navigationItems = [
  ...
  { name: "Student Records", href: "/registrar-records", icon: Users },
  { name: "Enrollments", href: "/registrar-enrollments", icon: UserCheck },
  { name: "Transcripts", href: "/registrar-transcripts", icon: FileText },
  { name: "Academic Calendar", href: "/registrar-calendar", icon: Calendar },
  { name: "Course Catalog", href: "/registrar-courses", icon: BookOpen },
  { name: "Profile", href: "/registrar-profile", icon: User },
];

const RegistrarSidebar: React.FC<RegistrarSidebarProps> = ({ isCollapsed, setIsCollapsed }) => {
          ...
          {!isCollapsed && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-white/60 text-xs">Registrar Portal</p>
              </div>
            </motion.div>
          )}
        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          {!isCollapsed && (
            <motion.div
              ...
              transition={{ delay: 0.1 }}
            >
              <p className="text-white text-sm font-medium">James Tubman</p>
              <p className="text-white/60 text-xs">Registrar</p>
            </motion.div>
          )}
        </div>
