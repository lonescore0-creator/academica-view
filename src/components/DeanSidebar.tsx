...
const navigationItems = [
  ...
  { name: "Student Affairs", href: "/dean-student-affairs", icon: Users },
  { name: "Discipline", href: "/dean-discipline", icon: Shield },
  { name: "Counseling", href: "/dean-counseling", icon: Heart },
  { name: "Attendance", href: "/dean-attendance", icon: ClipboardCheck },
  { name: "Incidents", href: "/dean-incidents", icon: AlertTriangle },
  { name: "Reports", href: "/dean-reports", icon: FileText },
  { name: "Profile", href: "/dean-profile", icon: User },
];

const DeanSidebar: React.FC<DeanSidebarProps> = ({ isCollapsed, setIsCollapsed }) => {
          ...
          {!isCollapsed && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-white/60 text-xs">Dean of Students Portal</p>
              </div>
            </motion.div>
          )}
        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          {!isCollapsed && (
            <motion.div
              ...
              transition={{ delay: 0.1 }}
            >
              <p className="text-white text-sm font-medium">Mary Johnson</p>
              <p className="text-white/60 text-xs">Dean of Students</p>
            </motion.div>
          )}
        </div>
